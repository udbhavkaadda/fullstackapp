...
connection_string = "Driver={ODBC Driver 17 for SQL Server};Server=tcp:servervm.database.windows.net,1433;Database=databasevm;Uid=adminserver;Pwd={admin@123456};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;}"
